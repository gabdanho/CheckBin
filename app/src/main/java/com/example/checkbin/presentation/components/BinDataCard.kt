...
import com.example.checkbin.presentation.mapper.BinDataMapper.UNKNOWN_VALUE
...
fun BinDataCard(
    ...
    Card(modifier = modifier.padding(defaultDimensions.small)) {
        ...
        Column(modifier = Modifier.padding(defaultDimensions.small)) {
            ...
            Text(
                stringResource(id = R.string.text_bank_city, binData.bank.name, binData.bank.city),
                ...
                modifier = Modifier
                    ...
                    .clickable {
                        if (binData.country.latitude != UNKNOWN_VALUE && binData.country.longitude != UNKNOWN_VALUE) onCityClick()
                    }
            )
            Text(
                stringResource(id = R.string.text_url, binData.bank.url),
                style = MaterialTheme.typography.labelMedium,
                color = Color.Blue,
                textDecoration = TextDecoration.Underline,
                modifier = Modifier
                    .padding(bottom = defaultDimensions.small)
                    .clickable { if (binData.bank.url != UNKNOWN_VALUE) onSiteClick() }
            )
            Text(
                stringResource(id = R.string.text_phone, binData.bank.phone),
                style = MaterialTheme.typography.labelMedium,
                color = Color.Blue,
                textDecoration = TextDecoration.Underline,
                modifier = Modifier.clickable {
                    if (binData.bank.phone != UNKNOWN_VALUE) onPhoneClick()
                }
            )
        }
    }
